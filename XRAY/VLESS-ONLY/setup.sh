...
#Welcome Note
echo -e "============================================="
echo -e " ${green} WELCOME TO JINGGO SCRIPT VLESS ONLY${NC}"
echo -e "============================================="
sleep 2
...
echo -e "============================================="
sleep 2
wget https://raw.githubusercontent.com/JinGGoVPN/DATA/main/XRAY/VLESS-ONLY/tools.sh && chmod +x tools.sh && screen -S tools ./tools.sh
sleep 2
clear
...
echo -e "============================================="
sleep 2
wget https://raw.githubusercontent.com/JinGGoVPN/DATA/main/XRAY/VLESS-ONLY/install-xray.sh && chmod +x install-xray.sh && screen -S v2ray ./install-xray.sh
sleep 2
clear
