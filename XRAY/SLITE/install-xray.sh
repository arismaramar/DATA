...
iptables -I INPUT -m state --state NEW -m tcp -p tcp --dport 65432 -j ACCEPT
...
iptables -I INPUT -m state --state NEW -m udp -p udp --dport 65432 -j ACCEPT
...
cd /usr/local/bin
wget -O add-xvmess "https://raw.githubusercontent.com/JinGGoVPN/DATA/main/XRAY/LITE/add-xvmess.sh"
wget -O del-xvmess "https://raw.githubusercontent.com/JinGGoVPN/DATA/main/XRAY/LITE/del-xvmess.sh"
wget -O renew-xvmess "https://raw.githubusercontent.com/JinGGoVPN/DATA/main/XRAY/LITE/renew-xvmess.sh"
wget -O cek-xvmess "https://raw.githubusercontent.com/JinGGoVPN/DATA/main/XRAY/LITE/cek-xvmess.sh"
...
wget -O trial-xvmess "https://raw.githubusercontent.com/JinGGoVPN/DATA/main/XRAY/LITE/trial-xvmess.sh"
